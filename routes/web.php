...
Route::group(['prefix'=>'admin'], function (){
    ...
    Route::group(['prefix'=>'subject'], function(){
        ...
        Route::get('create','SubjectController@create')->name('subject.create')->name('subject.create');
    ...
    Route::group(['prefix'=>'studentsubject'], function(){
        ...
        Route::get('edit', 'StudentSubjectController@edit')->name('studentsubject.edit');
